 ...
 class Car {
   constructor(id, x, y, color) {
       ...
       if (this.type === "Hauler, Truck") {
         ...
         this.width = 19;                            // Wider than Commuter, Sedan (16)
         this.length = 34;                           // Bulky frame
         this.baseSpeed = 1.5 + Math.random() * 0.5; // Faster than Commuter, Sedan (1.5 - 2.0)
         this.turnSpeed = 0.065;                     // Better steering than Commuter, Sedan (0.05)
