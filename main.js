...
respawnBtn.addEventListener('click', () => {
    ...
    if (status.active) {
        // Teleport to a random valid road position instead of a blind offset
        
        player.x = 300;
        player.y = 300;

        // Instantly force a local storage save at the new coordinates
        localStorage.setItem("gma_player_x", player.x.toFixed(2));
        localStorage.setItem("gma_player_y", player.y.toFixed(2));
