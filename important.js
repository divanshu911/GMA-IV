    ...
    buildGrid() {
        ...
        for (let gy = 0; gy < this.gridHeight; gy++) {
            ...
            for (let gx = 0; gx < this.gridWidth; gx++) {
                ...
                // Sample the CENTER of the navigation cell.
                const world = this.gridToWorld(gx, gy);

                let walkable = true;

                // Use the game's existing AI-car collision test
                // instead of creating a second collision definition.
                if (typeof isAICarWalkable === "function") {
                    walkable = isAICarWalkable(
                        world.x,
                        world.y
                    );
                }
        ...
        console.log(
            `Navigation grid created: ${this.gridWidth} × ${this.gridHeight}`
        );
