...
function isGrassOrRoad(x, y) {
    ...
    const isRoad = (Math.abs(r - g) < 35 && Math.abs(g - b) < 35 && Math.abs(r - b) < 35 && r > 20);
    const isGrass = (g > r + 15 && g > b + 15);
    const isPeachOrBeige = (r > 170 && g > 130 && b > 120 && r > b + 20);
    const isTransitionEdge = (Math.abs(r - g) < 40 && Math.abs(g - b) < 40 && Math.abs(r - b) < 40);
...
function isWalkableColor(nextX, nextY, entitySize = 24) {
  ...
  const isPeach = (r > 170 && g > 130 && b < 180 && r > b + 25);
  const isBeige = (r > 180 && g > 180 && b > 150 && Math.abs(r - g) < 25);
  const isTransitionEdge = (Math.abs(r - g) < 40 && Math.abs(g - b) < 40 && Math.abs(r - b) < 40);
...
function isPlayerCarWalkable(x, y) {
  ...
  const isPeach = (r > 170 && g > 130 && b < 180 && r > b + 25);
  const isBeige = (r > 180 && g > 180 && b > 150 && Math.abs(r - g) < 25);
  const isEdgeTransition = (Math.abs(r - g) < 40 && Math.abs(g - b) < 40 && Math.abs(r - b) < 40);
...
window.addEventListener('load', () => {
    ...
    // Position Tow Truck Button at Bottom-Left
    if (towTruckBtn) {
