...
window.addEventListener('load', () => {
    ...
    towTruckBtn = initHomeBtn('towTruckBtn', 'TOW TRUCK ($250)', '#e67e22', '160px');
    ...
    repairModal.innerHTML = `
        ...
        <div style="display:flex; justify-content:center; gap:15px; margin-top:15px;">
            <button id="confirmRepairBtn" style="padding:8px 18px; background:#2ecc71; color:#fff; border:none; border-radius:5px; font-weight:bold; cursor:pointer;">REPAIR</button>
